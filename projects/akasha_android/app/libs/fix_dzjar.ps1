...
$stub = Join-Path $root "akasha\libs\dz260\stubs\androidx\core\os\BundleCompat.java"
$out  = Join-Path $root "akasha\libs\dz260\stubout"
$jar  = Join-Path $root "akasha\libs\dhizuku-api\classes.jar"
